...
public class Lunar {
    ...
    //有关阴历 的信息，http://blog.csdn.net/geniushorse/article/details/71439201
    ...
    /**
     * 以下的几个方法，都是采用位运算，都是基于 农历的信息，具体可以参考上面那篇博客，那里面有农历的含义
     */
    ...
    public static String getChinaDayString(int day) {//获取初几
